...
d3.json('/assets/data/kor_admin_1.topojson').then(function(data1){
    ...
    d3.json('/assets/data/kor_admin_2.topojson').then(function(data2){
        // Read level 3 map data
        d3.json('/assets/data/kor_admin_3.topojson').then(function(data3){
